<%
const L_Title_Text                         = "DCS Account Manager"
const L_ISM_Text                           = "DCS Account Manager"
const L_IIS6_Text                          = "for Trendsdi account change password"
...
const L_PasswordToShort_Text               = "The password isn't  meet account policy. Either the password is too short, the same in the past or to change password twice today." 
